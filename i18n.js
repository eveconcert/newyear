...
const translations = {
  en: {
    ...
    ticket_eyebrow: "Ethiopian New Year's Eve Concert",
    ticket_subheading: "Happy Enkutatash! — Addis Ababa",
  ...
  am: {
    ...
    package_vip_name: "ቪ.ቪ.አይ.ፒ",
    field_tickets: "ትኬት ብዛት",
    ticket_picker_hint: "እንደፈለጉት ይምረጡ — ከሁለቱም ዓይነት ትኬት መግዛት ይችላሉ።",
    ticket_picker_hint_limit: "በአንድ ትዕዛዝ ቢበዛ 6 ትኬቶች ብቻ።",
    total_label: "ጠቅላላ",
    ...
    ticket_eyebrow: "የኢትዮጵያ አዲስ ዓመት ኮንሰርት",
    ticket_subheading: "እንኳን አደረሰዎት! — አዲስ አበባ",
